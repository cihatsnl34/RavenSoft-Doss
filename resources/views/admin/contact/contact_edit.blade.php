            ...
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <div class="js-wizard-simple block block">
                        ...
                        <!-- Form -->
                        <form class="js-wizard-validation-form" action="{{ route('admin.contact_update',['id' => $contactData->id]) }}" method="POST">
                            @csrf
                            <!-- Wizard Progress Bar -->
                            ...
                            <div class="block-content block-content-full tab-content px-md-5" style="min-height: 300px;">
                                ...
                                <div class="tab-pane active" id="wizard-validation-step1" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $contactData->email }}" name="email" type="email"
                                            id="wizard-validation-firstname">
                                    </div>
                                    <div class="form-group">
                                        <label for="wizard-validation-bio">Phone</label>
                                        <input class="form-control" value="{{ $contactData->phone }}" name="phone" type="number"
                                            id="wizard-validation-firstname">
                                    </div>
                                    <div class="form-group">
                                        <label for="wizard-validation-bio">Adress</label>
                                        <textarea class="form-control"  id="wizard-validation-bio" name="adress" rows="5"><?=$contactData->adress?></textarea>
                                    </div>
                                </div>
                                <!-- END Step 1 -->
                                <!-- Step 2 -->
                                <div class="tab-pane" id="wizard-validation-step2" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{ $contactData->facebookUrl }}" type="text" id="wizard-validation-firstname"
                                            name="facebookUrl">
                                    </div>
                                    <div class="form-group">
                                        <label for="wizard-validation-firstname">Twitter Url</label>
                                        <input class="form-control" value="{{ $contactData->twitterUrl }}" type="text" id="wizard-validation-firstname"
                                            name="twitterUrl">
                                    </div>
                                    <div class="form-group">
                                        <label for="wizard-validation-firstname">İnstagram Url</label>
                                        <input class="form-control" value="{{ $contactData->instagramUrl }}" type="text" id="wizard-validation-firstname"
                                            name="instagramUrl">
                                    </div>
                                    <div class="form-group">
                                        <label for="wizard-validation-firstname">Linkedin Url</label>
                                        <input class="form-control" value="{{ $contactData->linkedinUrl }}" type="text" id="wizard-validation-firstname"
                                            name="linkedinUrl">
                                    </div>
                                </div>
                                <!-- END Step 2 -->
